...
class DropDown extends react.Component {
  render() {
    ...
    return /*#__PURE__*/react.createElement("div", {
      className: "autosuggestion-dropdown",
      style: dropDownStyle
    }, this.props.searchHistory.map((val, index) => {
      return /*#__PURE__*/react.createElement("div", {
        key: index,
        onMouseDown: e => {
          this.props.updateSearchText(e.target.innerText);
  ...
  render() {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      onKeyUp: e => {
        ...
        e.target.style.width = "auto"; // this function is executing considering the data in server may get updated
      ...
      onBlur: e => {
        this.props.updateSearchText(this.props.searchSuggestion);
        e.target.style.width = "80%";
        this.props.hideDropDown();
      }
    }, this.props.searchText), /*#__PURE__*/react.createElement("span", {
      style: {
        'display': 'inline-block',
        'color': 'white',
    ...
    }, searchSuggestion), /*#__PURE__*/react.createElement("span", {
      onClick: () => this.props.updateSearchText(''),
      style: {
        'display': 'inline-block',
        'textOverflow': 'ellipsis'
      },
      className: "search-box-cross",
      style: {
        'float': 'right',
        'marginTop': '6px',
        'marginRight': '5px',
...
class Container extends react.Component {
  ...
  render() {
    return /*#__PURE__*/react.createElement("div", {
      ...
      dataurl: this.state.config.dataurl,
